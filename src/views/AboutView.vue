...
<template>
  ...
  >
    <div class="flex-1 w-full bg-gray-500/20">
      <div
        class="w-full max-w-265 mx-auto min-h-min bg-white/85 backdrop-blur-sm rounded-lg mb-10 mt-30 shadow-xl"
      >
        <div class="card flex flex-col items-center overflow-hidden">
          <div class="flex flex-col items-center gap-2">
            <span class="text-xl font-medium text-gray-500 pt-5 pb-3"
              >Промотайте вниз, чтобы узнать больше о менеджере задач uTasks!</span
            >
            <span
          ...
          <div class="flex flex-wrap justify-center gap-8">
            ...
            >
              ...
              <span class="text-center"
                >Никто не украдёт Ваши данные из базы данных, которой нет 😎. Пока нет...</span
              >
            </div>
          </div>
          <div class="h-[30rem]"></div>
          <div class="flex flex-wrap justify-center gap-8">
            ...
            >
              ...
              <span class="text-muted-color text-center"
                >Прогрессивный JavaScript-фреймворк, менеджер задач uTasks написан на нём</span
              >
            </div>
            <div
              v-animateonscroll="{
            ...
            >
              ...
              <span class="text-muted-color text-center"
                >Предоставляет набор из готовых элементов пользовательского интерфейса для
                Vue.js</span
              >
            </div>
            <div
            ...
            >
              ...
              <span class="text-muted-color text-center"
                >CSS-фреймворк, который позволяет использовать готовые классы прямо в разметке
                Vue</span
              >
            </div>
          </div>
          <span class="text-xl font-medium text-gray-500 pt-70 pb-5 text-center"
            >Разработал Ключников А.Д., ЭФБО-09-23</span
          >
        </div>
      </div>
    </div>
